...
Config.defaultlang = "pt" -- options available: pt,en,br or add them yourself.
...
Config.Anims = {--Examples here https://raw.githubusercontent.com/femga/rdr3_discoveries/master/animations/ingameanims/ingameanims_list.lua
  ...
  fill_Bucket_A         = "amb_work@prop_human_pump_water@female_b@idle_a",
  fill_Bucket_B         = "idle_a",
...
--[[
  IT IS NECESSARY ADD ITEMS TO THE USABLE INTO THE METABOLISM PLUGIN BUT NOT THE 'empty_canteen' BECAUSE DONT HAS NOTHING TO DRING FROM IT
]]
