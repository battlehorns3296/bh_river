...
AddEventHandler("checkcanteen", function(rock)
  ...
  elseif canteen_80 > 0 then
    TriggerClientEvent("canteencheck_80", _source)
  elseif canteen_60 > 0 then
    TriggerClientEvent("canteencheck_60", _source)
  elseif canteen_40 > 0 then
    TriggerClientEvent("canteencheck_40", _source)
  elseif canteen_20 > 0 then
    TriggerClientEvent("canteencheck_20", _source)
